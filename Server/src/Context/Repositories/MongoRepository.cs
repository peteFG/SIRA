...
namespace Context.Repositories
{
    ...
    {
        protected ILogger log = Logger.ContextLog<MongoDocument>();
        ...
        public MongoRepository(MongoDBContext Context)
        {
            ...
            /* var properties = typeof(TEntity).GetProperties().Where(prop => prop.IsDefined(typeof(BsonUniqueAttribute), false));
             ...
             if (properties != null)
             {
                 foreach (PropertyInfo prop in properties)
                 {
                     ...
                     _collection.Indexes.CreateOne("{ " + prop.Name + " : 1 }", options);
                 }
             }*/
        }
