    ...
    public static class Converter
    {
        public static int ConvertToInteger(Object text, int standard = 0)
        {
            ...
            if (text != null && text.Equals(DBNull.Value) == false)
            {
                ...
                if (int.TryParse(text + "", NumberStyles.Any, CultureInfo.InvariantCulture,
                        out number))
                {
                    output = number;
                }
        ...
        public static Double ConvertToDouble(Object text, Double standard = 0)
        {
            ...
            if (text != null && text.Equals(DBNull.Value) == false)
            {
                ...
                if (Double.TryParse(mytext, NumberStyles.Any, CultureInfo.InvariantCulture,
                        out number))
                {
                    output = number;
                }
        ...
        public static short ConvertToShort(Object text, short standard = 0)
        {
            ...
            if (text != null && text.Equals(DBNull.Value) == false)
            {
                String mytext = text + "";
                mytext = mytext.Replace(',', '.');
                if (short.TryParse(mytext, NumberStyles.Any, CultureInfo.InvariantCulture,
                        out number))
                {
                    output = number;
                }
        ...
        public static long ConvertToLong(Object text, long standard = 0)
        {
            ...
            if (text != null && text.Equals(DBNull.Value) == false)
            {
                String mytext = text + "";
                mytext = mytext.Replace(',', '.');
                if (long.TryParse(mytext, NumberStyles.Any, CultureInfo.InvariantCulture,
                        out number))
                {
                    output = number;
                }
        ...
        {
            int number;
            if (int.TryParse(text, NumberStyles.Any, CultureInfo.InvariantCulture, out number))
            {
                return true;
            }
            else
